...
teachingmethod_enroll%>%
  ...
  ggplot(aes(x= reorder(teachingmethod,-total_teaching),y = total_teaching))+geom_bar(stat = 'identity',fill='salmon3',width = 0.8)+labs(y = "Number of Enrollments",x='Teaching Method',title='Distribution of Student Enrollments in Ohio by Teaching Method')+theme_minimal()+theme(axis.text = element_text(size = 13),title = element_text(size=13))
