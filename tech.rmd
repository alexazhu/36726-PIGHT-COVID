...
ggsave("p5.png",width = 7.5,height = 6)
##5w-2w
B_diff_micro%>%
  ...
  labs(y="Change in Growth",x="Log of Population Density",
       ...
       size = "2w~5w\nAveraged %6hr+ Away Home",
       alpha= "2w~5w\nAveraged %6hr+ Away Home" ,fill="Majority Teaching Method")+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")+geom_text(data =B_diff_micro%>%filter(major_teaching=="On Premises"),aes(label=COUNTY),color='black',size=3,hjust=1.1, vjust=0.3)
ggsave("p6.png",width = 7.5,height = 6)
##4w-1w
B_diff_micro%>%
  ...
  labs(y="Change in Growth",x="Log of Population Density",
       ...
       size = "1w~4w\nAveraged %6hr+ Away Home",
       alpha= "1w~4w\nAveraged %6hr+ Away Home" ,fill="Majority Teaching Method")+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")+geom_text(data =B_diff_micro%>%filter(major_teaching=="On Premises"),aes(label=COUNTY),color='black',size=3,hjust=1.1, vjust=0.3)
ggsave("p7.png",width = 7.5,height = 6)
##7w-4w
B_diff_micro%>%
  ...
  labs(y="Change in Growth",x="Log of Population Density",
       ...
       size = "4w~7w\nAveraged %6hr+ Away Home",
       alpha= "4w~7w\nAveraged %6hr+ Away Home" ,fill="Majority Teaching Method")+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")+geom_text(data =B_diff_micro%>%filter(major_teaching=="On Premises"),aes(label=COUNTY),color='black',size=3,hjust=1.1, vjust=0.3)
ggsave("p8.png",width = 7.5,height = 6)
...
# Plotting B before/after school

# for micropolitan counties only

# B(6) - B(3) v.s. B(3) - B(0)
```{r}
B_diff %>%
  filter(NCHS.Urban.Rural.Status == 'Micropolitan') %>%
  ggplot(aes(x=new.slope.diff,y=new.slope.diff2, group=major_teaching,color=major_teaching))+ geom_point(aes(size=avg_full_work_prob,alpha=avg_full_work_prob))+theme_minimal()+team_theme+labs(y="Change in Growth after school reopens ",x="Change in Growth before school reopens",title="Change in Growth before/after school reopens\nOnly Micropolitan Counties",color="Majority Teaching Method", size = "0w~3w\nAveraged %6hr+ Away Home",alpha= "0w~3w\nAveraged %6hr+ Away Home" ,fill='Majority Teaching Method')+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")

ggsave("micro_b036.png",width = 7, height = 5)
```
...
B_diff %>%
  filter(NCHS.Urban.Rural.Status == 'Micropolitan') %>%
  ggplot(aes(x=new.slope.diff2m1,y=new.slope.diff52, group=major_teaching,color=major_teaching))+ geom_point(aes(size=avg_full_work_prob_m1w2w,alpha=avg_full_work_prob_m1w2w))+theme_minimal()+team_theme+labs(y="Change in Growth after school reopens ",x="Change in Growth before school reopens",title="Change in Growth before/after school reopens\nOnly Micropolitan Counties",color="Majority Teaching Method", size = "(-1)w~2w\nAveraged %6hr+ Away Home",alpha= "(-1)w~2w\nAveraged %6hr+ Away Home" ,fill='Majority Teaching Method')+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")

ggsave("micro_bm125.png",width = 7, height = 5)
```
...
B_diff %>%
  filter(NCHS.Urban.Rural.Status == 'Micropolitan') %>%
  ggplot(aes(x=new.slope.diff1m2,y=new.slope.diff41, group=major_teaching,color=major_teaching))+ geom_point(aes(size=avg_full_work_prob_m2w1w,alpha=avg_full_work_prob_m2w1w))+theme_minimal()+team_theme+labs(y="Change in Growth after school reopens ",x="Change in Growth before school reopens",title="Change in Growth before/after school reopens\nOnly Micropolitan Counties",color="Majority Teaching Method", size = "(-2)w~1w\nAveraged %6hr+ Away Home",alpha= "(-2)w~1w\nAveraged %6hr+ Away Home" ,fill='Majority Teaching Method')+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")

ggsave("micro_bm214.png",width = 7, height = 5)
```
...
B_diff %>%
  filter(NCHS.Urban.Rural.Status == 'Micropolitan') %>%
  ggplot(aes(x=new.slope.diff0m3,y=new.slope.diff, group=major_teaching,color=major_teaching))+ geom_point(aes(size=avg_full_work_prob_m3w0w,alpha=avg_full_work_prob_m3w0w))+theme_minimal()+team_theme+labs(y="Change in Growth after school reopens ",x="Change in Growth before school reopens",title="Change in Growth before/after school reopens\nOnly Micropolitan Counties",color="Majority Teaching Method", size = "(-3)w~0w\nAveraged %6hr+ Away Home",alpha= "(-3)w~0w\nAveraged %6hr+ Away Home" ,fill='Majority Teaching Method')+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")

ggsave("micro_bm303.png",width = 7, height = 5)
```
...
B_diff %>%
  filter(NCHS.Urban.Rural.Status == 'Micropolitan') %>%
  ggplot(aes(x=new.slope.diff41,y=new.slope.diff74, group=major_teaching,color=major_teaching))+ geom_point(aes(size=avg_full_work_prob_1w4w,alpha=avg_full_work_prob_1w4w))+theme_minimal()+team_theme+labs(y="Change in Growth after school reopens ",x="Change in Growth before school reopens",title="Change in Growth before/after school reopens\nOnly Micropolitan Counties",color="Majority Teaching Method", size = "1w~4w\nAveraged %6hr+ Away Home",alpha= "1w~4w\nAveraged %6hr+ Away Home" ,fill='Majority Teaching Method')+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")

ggsave("micro_b147.png",width = 7, height = 5)
```
...
B_diff %>%
  filter(NCHS.Urban.Rural.Status == 'Micropolitan') %>%
  ggplot(aes(x=new.slope.diff,y=new.slope.diff2, group=major_teaching,color=major_teaching))+ geom_point(aes(size=avg_full_work_prob,alpha=avg_full_work_prob))+theme_minimal()+geom_smooth(method = "lm", se=F,
              formula = y ~ x,alpha=0.1)+team_theme+labs(y="Change in Growth after school reopens ",x="Change in Growth before school reopens",title="Change in Growth before/after school reopens\nOnly Micropolitan Counties",color="Majority Teaching Method", size = "0w~3w\nAveraged %6hr+ Away Home",alpha= "0w~3w\nAveraged %6hr+ Away Home" ,fill='Majority Teaching Method')+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")

ggsave("micro_b036_lines.png",width = 7, height = 5)
```
...
B_diff %>%
  filter(NCHS.Urban.Rural.Status == 'Micropolitan') %>%
  ggplot(aes(x=new.slope.diff2m1,y=new.slope.diff52, group=major_teaching,color=major_teaching))+ geom_point(aes(size=avg_full_work_prob_m1w2w,alpha=avg_full_work_prob_m1w2w))+geom_smooth(method = "lm", se=F,
              formula = y ~ x,alpha=0.1)+theme_minimal()+team_theme+labs(y="Change in Growth after school reopens ",x="Change in Growth before school reopens",title="Change in Growth before/after school reopens\nOnly Micropolitan Counties",color="Majority Teaching Method", size = "(-1)w~2w\nAveraged %6hr+ Away Home",alpha= "(-1)w~2w\nAveraged %6hr+ Away Home" ,fill='Majority Teaching Method')+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")

ggsave("micro_bm125_lines.png",width = 7, height = 5)
```
...
B_diff %>%
  filter(NCHS.Urban.Rural.Status == 'Micropolitan') %>%
  ggplot(aes(x=new.slope.diff1m2,y=new.slope.diff41, group=major_teaching,color=major_teaching))+ geom_point(aes(size=avg_full_work_prob_m2w1w,alpha=avg_full_work_prob_m2w1w))+geom_smooth(method = "lm", se=F,
              formula = y ~ x,alpha=0.1)+theme_minimal()+team_theme+labs(y="Change in Growth after school reopens ",x="Change in Growth before school reopens",title="Change in Growth before/after school reopens\nOnly Micropolitan Counties",color="Majority Teaching Method", size = "(-2)w~1w\nAveraged %6hr+ Away Home",alpha= "(-2)w~1w\nAveraged %6hr+ Away Home" ,fill='Majority Teaching Method')+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")

ggsave("micro_bm214_lines.png",width = 7, height = 5)
```
...
B_diff %>%
  filter(NCHS.Urban.Rural.Status == 'Micropolitan') %>%
  ggplot(aes(x=new.slope.diff0m3,y=new.slope.diff, group=major_teaching,color=major_teaching))+ geom_point(aes(size=avg_full_work_prob_m3w0w,alpha=avg_full_work_prob_m3w0w))+geom_smooth(method = "lm", se=F,
              formula = y ~ x,alpha=0.1)+theme_minimal()+team_theme+labs(y="Change in Growth after school reopens ",x="Change in Growth before school reopens",title="Change in Growth before/after school reopens\nOnly Micropolitan Counties",color="Majority Teaching Method", size = "(-3)w~0w\nAveraged %6hr+ Away Home",alpha= "(-3)w~0w\nAveraged %6hr+ Away Home" ,fill='Majority Teaching Method')+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")

ggsave("micro_bm303_lines.png",width = 7, height = 5)
```
...
B_diff %>%
  filter(NCHS.Urban.Rural.Status == 'Micropolitan') %>%
  ggplot(aes(x=new.slope.diff41,y=new.slope.diff74, group=major_teaching,color=major_teaching))+ geom_point(aes(size=avg_full_work_prob_1w4w,alpha=avg_full_work_prob_1w4w))+geom_smooth(method = "lm", se=F,
              formula = y ~ x,alpha=0.1)+theme_minimal()+team_theme+labs(y="Change in Growth after school reopens ",x="Change in Growth before school reopens",title="Change in Growth before/after school reopens\nOnly Micropolitan Counties",color="Majority Teaching Method", size = "1w~4w\nAveraged %6hr+ Away Home",alpha= "1w~4w\nAveraged %6hr+ Away Home" ,fill='Majority Teaching Method')+scale_color_manual(values=col_theme)+theme(legend.position = "bottom")

ggsave("micro_b147_lines.png",width = 7, height = 5)
```
