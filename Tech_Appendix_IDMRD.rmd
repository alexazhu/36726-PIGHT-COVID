...
## 1.1 Geographical distribution of the majority teaching posture, population and student enrollmen tat county-level
...
## 1.4 Map of counties' Micropolitan status
...
## Compute the maximum B values for each county during the Fall semester
...
## Growth coefficient aggregation by counties majority teaching posture
