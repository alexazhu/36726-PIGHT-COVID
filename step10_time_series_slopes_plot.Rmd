...
cases_clean_teach_agg%>%
  ...
  left_join(cum_mobility%>%filter(major_teaching=="On Premises"),by="DATE")%>%
  ggplot(aes(x = DATE))+
...
cases_clean_teach_agg%>%
  ...
  labs(x = "Cumulative Full-time Workers/Students", y = "Exponential Growth Coefficient", 
       title = "B ~ Cumulative Full-time Workers/Students for On Premises")+theme(text = element_text(size=14),title = element_text(size=16))
...
cases_clean_teach_agg%>%
  ...
  left_join(cum_mobility%>%filter(major_teaching=="Hybrid"),by="DATE")%>%
  ggplot(aes(x = DATE))+
...
cases_clean_teach_agg%>%
  ...
  theme_minimal() + theme(legend.position = "bottom")+
  labs(x = "Cumulative Full-time Workers/Students", y = "Exponential Growth Coefficient", 
       title = "B ~ Cumulative Full-time Workers/Students for Hybrid")+theme(text = element_text(size=14),title = element_text(size=16))
...
cases_clean_teach_agg%>%
  ...
  left_join(cum_mobility%>%filter(major_teaching=="Online Only"),by="DATE")%>%
  ggplot(aes(x = DATE))+
...
cases_clean_teach_agg%>%
  ...
  theme_minimal() + theme(legend.position = "bottom")+
  labs(x = "Cumulative Full-time Workers/Students", y = "Exponential Growth Coefficient", 
       title = "B ~ Cumulative Full-time Workers/Students for Online Only")+theme(text = element_text(size=14),title = element_text(size=16))
