...
na.omit(B0B1)%>%
  ...
  labs(y="Max Growth Coefficient B",x="Majority Teaching Method",title="Distribution of Maximum Growth Coefficient in Micropolitan Counties",
       fill="Majority Teaching Method")+
  scale_fill_manual(values=col_theme)
...
B_diff%>%
  ...
  facet_grid(~major_teaching)+
  geom_boxplot()+
  labs(fill="Majority Teaching Method",size="Averaged \n%6hr+ Away Home",
