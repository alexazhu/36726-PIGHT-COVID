...
# Fit Splines to Log( New Deaths + 1 ) and Log( Total Deaths + 1 )
# take first derivative of spline -- slope as the growth coefficients B
...
#writes.csv(log_deaths_county,"../Data/Cleaned_Data/county_splines_slopes.csv")
