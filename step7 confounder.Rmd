...
```{r}
################### school reopen dates ################### 
shutdown_reopen <- OH_K12 %>%
  distinct(county,county_enroll,leaid,district_enroll,schooltemporaryshutdown,opendategrouped,teachingmethod)

table(shutdown_reopen[,c('teachingmethod','schooltemporaryshutdown')])
#table(shutdown_reopen[,c('county','opendategrouped')])
```
